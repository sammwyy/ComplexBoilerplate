...
import com.sammwy.boilerplate.players.OfflinePlayer;
import com.sammwy.boilerplate.players.PluginPlayer;
import com.sammwy.boilerplate.utils.BukkitUtils;
...
public class CommandArguments {
    ...
    public CommandArguments(BukkitBoilerplate plugin, Argument[] requiredArguments) {
        this.plugin = plugin;
    ...
    public PluginPlayer getPlayer(int index) {
        if (!this.hasIndex(index))
            return null;
        return (PluginPlayer) this.arguments.get(index);
    }
