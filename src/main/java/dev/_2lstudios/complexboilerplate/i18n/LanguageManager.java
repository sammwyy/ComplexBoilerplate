package dev._2lstudios.complexboilerplate.i18n;
...
import dev._2lstudios.complexboilerplate.utils.FileUtils;
...
public class LanguageManager {
    ...
    public LanguageManager(final ComplexBoilerplate plugin) {
        this(
